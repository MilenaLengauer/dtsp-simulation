...
{
    public class DiversityHeatMapViewModel : NotifyPropertyChanged
    {
        ...
        public DiversityHeatMapViewModel(DynamicTSPSolution solution)
        {
        ...
        private void BuildChart(int generation)
        {
            ...
            if(generationReport == null || generationReport.PopulationDiversityMap == null)
            {
                return;
            }
            var model = new PlotModel();
            double[,] diversityMap = generationReport.PopulationDiversityMap;
